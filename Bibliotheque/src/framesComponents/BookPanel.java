...
public class BookPanel extends JPanel implements DefineComponents{
    ...
    public void initialiserComposants() {
        ...
        final String L_1AUTHOR2NAME = "Nom 1" + er + " auteur:";
        final String L_1AUTHOR1NAME = "Prénom 1" + er + " auteur:";
        final String L_2AUTHOR2NAME = "Nom 2" + e + " auteur:";
        final String L_2AUTHOR1NAME = "Prénom 2" + e + " auteur:";
        final String L_3AUTHOR2NAME = "Nom 3" + e + " auteur:";
        final String L_3AUTHOR1NAME = "Prénom 3" + e + " auteur:";
